...
const Footer = () => (
  ...
  <div className="row">
      <div className="column social">
          ...
          <a href="#" target="_blank" aria-label="Twitter"><svg
                                ...
                                <path
                                    ...
                                    fill="#ee1d52"></path>
                            </svg></a><a href="#" target="_blank" aria-label="LinkedIn"><svg
                                ...
                                <path
                                    ...
                                    fill="#75E6DA"></path>
                            </svg></a><a href="#" target="_blank" aria-label="Instagram"><svg
                                ...
                                <path
                                    ...
                                    fill="#F652A0"></path>
                            </svg></a><a href="#" target="_blank" aria-label="YouTube"><svg
