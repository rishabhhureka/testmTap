...
import { Done, AddIcon, RemoveIcon, AddPhotoAlternateIcon, ExpandMoreIcon } from '@mui/icons-material';
...
const Products = () => {
  ...
  const colors = [
    { name: 'danger', bgColor: 'danger.main' },
    { name: 'white', bgColor: 'common.white' },
    { name: 'black', bgColor: 'common.black' },
    { name: 'primary', bgColor: 'primary.main' },
  ];
                  ...
                  >
                    {colors.map((color) => (
                      <FormControlLabel
                        ...
                        control={
                          <Radio
                            icon={<span style={{ width: 24, height: 24, borderRadius: '50%', border: '2px solid black', backgroundColor: color.bgColor }} />}
