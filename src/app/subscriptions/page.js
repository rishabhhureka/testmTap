...
const AccordionItem = ({ question, answer, isOpen, onClick }) => (
  <div className={isOpen ? 'open accordion-group' : 'close accordion-group'}>
    <h4 onClick={onClick}>
      {question} <span><img className="plus" src="../../Img/plusIcon.svg" alt="plus" /><img className="minus" src="data:image/png;base64," alt="minus" /></span>
    </h4>
  ...
  <main>
      ...
      <div className="filter">
        <div className="form-group">
          <div className="btn-group">
            <button className="btn-default active btn btn-xs">
              <span className="fa-check-circle fa"></span> Pending
            </button>
            <button className="btn-success btn btn-xs">
              <span className="fa-circle fa"></span> Verify
            </button>
            <button className="btn-danger btn btn-xs">
              <span className="fa-circle fa"></span> Decline
            </button>
          </div>
      ...
      <div className="container container-xs">
        <div className="list-fix-row">
          ...
          <div className="col-fix-3 fix-type2">
          ...
          <div className="col-fix-3 fix-type3">
